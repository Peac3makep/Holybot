...
class CommandoClient extends discord.Client {
	 ...
	 * @property {boolean} [unknownCommandResponse=true] - Whether the bot should respond to an 
	 * @property {string|string[]|Set<string>} [owner] - ID of the bunknown commandot owner's Discord user, or multiple IDs
